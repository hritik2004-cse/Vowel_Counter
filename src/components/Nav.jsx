...
const Nav = () => {
    return (
        <nav className='w-full flex h-[10vh] items-center justify-between bg-transparent py-9'>
            ...
            <Button className='bg-gradient-to-r from-[#9363ff] via-[#c1a6ff] to-[#f5f0ff] rounded-3xl py-7 px-7 capitalize sm:text-sm md:text-md lg:text-lg hover:scale-[1.1] transition ease-in duration-400 font-[500]'>
